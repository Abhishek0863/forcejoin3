      ...
      try:
        ...
        try:
          sent_message = message.reply_text(
              "{}, you are **not subscribed** to my [channel](https://t.me/{}) yet. Please [join](https://t.me/{}) and **press the button below** to unmute yourself.\n__\n__channel link 👉 https://t.me/{}".format(message.from_user.mention, channel, channel, channel),
